...
app.service('Gmaps', function ($location, $q, $rootScope) {
    ...
    var service = {
        ...
        addMarker: function (marker) {
            ...
            if (marker.title) {
                ...
                if (marker.type) {
                    var str = '';
                    angular.forEach(marker.type, function(type, idx){
                        if(idx != 0 ) {
                            str = str + '&nbsp;' + type;
                        } else {
                            str = str + type;
                ...
                if(marker.information) {
                    ...
                    infoWindowContent += '<h6>' + marker.title + '</h6>';
                    infoWindowContent += '<div style="text-align:center">';
                    if (marker.link) {
                        infoWindowContent += '<a href="' + marker.link + '">';
                    }
                    infoWindowContent += '<img src="' + marker.information.image.url +'" height="' + marker.information.image.height + '" ';
                    infoWindowContent += 'width="' + marker.information.image.width + '" ';
                    infoWindowContent += 'alt="' + marker.information.image.alt + '" />';
                    if (marker.link) {
                        infoWindowContent += '</a>';
                    }
                    infoWindowContent += '</div>';
                    infoWindowContent += '<div>';
                    infoWindowContent += '<p tyle="text-align:center">';
                    infoWindowContent += marker.information.description
                    infoWindowContent += '</p>';
                    infoWindowContent += '</div>';
                    infoWindowContent += '</div>';
